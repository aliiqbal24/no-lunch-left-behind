...
Review the new mission and district sequence in the local preview. Atlas refinement remains a separate creative pass requiring owner approval. Deployment, jam fork/entry JSON, and the exact-commit public gate remain release tasks requiring owner approval.
