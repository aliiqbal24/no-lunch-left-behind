...
The rocket boarding refinement keeps the ladder as editable Three.js code. Its human-spaced rungs were reverified separately with the 404 recipe verifier: 1/1 clean, 26,984 triangles and 263 meshes before runtime baking. No external geometry or media was added.
...
- The City-to-orbit-to-Station 404 loading cinematic is original inline SVG and CSS, driven by real asset milestones. It ships no raster image, third-party font, downloaded model, or new audio.
